...
\begin{document}
  ...
  % Zhehao: consider merging the introduction to OpenWRT and LuCI from both section 1 and 2?
	...
	Based on the functional modules of LuCI, we design, the functional components of the Android application, which are organized into three major categories.
